...
```sh
node <skill>/scripts/run-scorecard.mjs --repo <repo> --entry-point App.csproj --skip-dependency-probe --npm-package /path/codemetrics-ai-0.2.0.tgz --dotnet-package /path/CodeMetrics.AI.2.0.0.nupkg --cache /path/test-cache
```
